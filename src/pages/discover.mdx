...
import CommonUseCases from "../components/CommonUseCases";

<Head>
  <title>Discover - Moondream Documentation</title>
  <meta
    name="description"
    content="Learn about Moondream's vision-language capabilities including image captioning, visual Q&A, object detection, and visual pointing. Explore use cases and find out if Moondream is right for your project."
  />
  ...
  <meta
    property="og:title"
    content="Discover Moondream - Vision-Language Model Capabilities & Use Cases"
  />
  <meta
  ...
  <script type="application/ld+json">
    {JSON.stringify({
      ...
      description:
        "Comprehensive guide to Moondream's vision AI capabilities and use cases",
      articleSection: "Technical Documentation",
      keywords:
        "vision AI, image understanding, machine learning, computer vision, image analysis",
    })}
  </script>
</Head>
...
<Callout type="info">
  The flexibility of VLMs means new use cases are constantly emerging as
  developers find innovative ways to apply the technology.
</Callout>
...
<Callout type="info">
  New to computer vision? Don't worry! Moondream is designed to be accessible
  while providing powerful capabilities. Start with our [quickstart
  guide](/quick-start) to see how easy it is to integrate vision AI into your
  applications.
</Callout>
