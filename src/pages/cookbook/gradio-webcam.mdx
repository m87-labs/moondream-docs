...
Create a real-time webcam interface for Moondream using Gradio.
...
```bash
pip install gradio torch transformers einops
```
...
Save this code as `webcam_app.py` and run it with:
